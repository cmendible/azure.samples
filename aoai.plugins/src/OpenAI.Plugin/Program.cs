OpenApiConfigurationOptions configOptions = new()
{
    ...
    {
        Version = "1.0.0",
        Title = "Greet Plugin Definition",
        Description = "This is a plugin that greets a person given it's name and age.",
    },
...
Kernel CreateKernel(IServiceProvider provider)
{
    ...
    builder.Plugins.AddFromPromptDirectory(semanticPromptsFolder, "Greet");
