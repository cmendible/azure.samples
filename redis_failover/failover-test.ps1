...
.\redis-cli\redis-benchmark -h $redis_host_name -a $redis_primary_access_key -p 6380 -t SET -n 10 -d 1024

# To test throughput: Pipelined GET requests with 1k payload:
.\redis-cli\redis-benchmark -h $redis_host_name -a $redis_primary_access_key -p 6380 -t GET -n 1000000 -d 1024 -c 50
